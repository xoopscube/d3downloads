...
define('_MD_D3DOWNLOADS_BEOBJECTIVE','By taking an objective approach, the ratings can be useful.');
...
define('_MD_D3DOWNLOADS_THANKSFORHELP','Thank you for taking the time to reach out and for helping to maintain Downloads integrity.');
define('_MD_D3DOWNLOADS_FORSECURITY','For security reasons your user name and IP address will be temporarily recorded.');
...
define('_MD_D3DOWNLOADS_LABEL_PERPAGE','Items per page');
...
define('_MD_D3DOWNLOADS_DATEOLD','Date (Older Listed First)');
define('_MD_D3DOWNLOADS_DATENEW','Date (Newest Listed First)');
define('_MD_D3DOWNLOADS_RATINGLTOH','Rating (Lowest to Highest Score)');
define('_MD_D3DOWNLOADS_RATINGHTOL','Rating (Highest to Lowest Score)');
...
define('_MD_D3DOWNLOADS_SUBMIT_POSTNAME','By');
...
define('_MD_D3DOWNLOADS_SUBMIT_MAXFILESIZE','Max file size : %s .');
...
define('_MD_D3DOWNLOADS_BTN_CANCEL','Cancel');
...
define('_MD_D3DOWNLOADS_VIEWHISTORY','View');
...
define('_MD_D3DOWNLOADS_INVISIBLE_NUM','Private items');
...
define('_MD_D3DOWNLOADS_BROKEN_NUM','Broken items');
define('_MD_D3DOWNLOADS_BROKENCHECK','Check Broken Files');
define('_MD_D3DOWNLOADS_LABEL_BROKENCHECKDONE','Check Bronken Files Done');
define('_MD_D3DOWNLOADS_CONFIRM_BROKENCHECK','Are you sure you want to check broken files? This feature only checks files uploaded by this module. ');
define('_MD_D3DOWNLOADS_NO_CATEGORY','Because there are no categories, new registrations can not be');
define('_MD_D3DOWNLOADS_UNAPPROVAL_NUM','Waiting items');
...
define('_MD_D3DOWNLOADS_LABEL_READ_INFO','View Permissions');
define('_MD_D3DOWNLOADS_GROUPNAME','Group Name');
define('_MD_D3DOWNLOADS_UID','User ID');
define('_MD_D3DOWNLOADS_UNAME','User Name');
define('_MD_D3DOWNLOADS_SUBMIT_URL_DESC','When you enter : XOOPS_TRUST_PATH, XOOPS_ROOT_PATH or XOOPS_URL<br>the conversion is automatically processed.');
...
define('_MD_D3DOWNLOADS_CONFIRM_COPY','Are you sure you want to copy? Downloaded files will be copied where possible, depending on the environment. Please check your titles carefully.');
...
define('_MD_D3DOWNLOADS_SEL_INTREE','Show subcategories');
define('_MD_D3DOWNLOADS_NO_INTREE','Hide subcategories');
define('_MD_D3DOWNLOADS_ADD_MYLINK','Add My Link');
define('_MD_D3DOWNLOADS_DEL_MYLINK','Remove from My Link');
define('_MD_D3DOWNLOADS_ADD_MYLINK_DONE','Added to My Link.');
define('_MD_D3DOWNLOADS_DEL_MYLINK_DONE','Deleted from My Link.');
...
define('_MD_D3DOWNLOADS_SUBMIT_SPACE','Space');
...
define('_MD_D3DOWNLOADS_SUBMIT_EXTRA_DESC','Input like this <span style="font-weight: bold;">&lt;&lt;title&gt;&gt;Description</span><br>Type in the text box below and it will automatically be the specified type..<br><span style="font-weight: bold;">BBCode</span> Available in description : <span style="font-weight: bold;">[title]</span>,<span style="font-weight: bold;">[filename]</span>,<span style="font-weight: bold;">[filename2]</span>,<span style="font-weight: bold;">[expired]</span>,<span style="font-weight: bold;">[pagebreak]</span>');
...
define('_MD_D3DOWNLOADS_BROKEN_MESSAGE','Message');
define('_MD_D3DOWNLOADS_BROKEN_NAME','Your name (optional)');
define('_MD_D3DOWNLOADS_BROKEN_EMAIL','Mail address (optional');
